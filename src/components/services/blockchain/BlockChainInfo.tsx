...
const BlockchainInfo: React.FC = () => {
  return (
    <div className="bg-[#0C2C4F]">
      <div className="text-white py-10 md:py-20 max-w-9xl mx-auto px-4 md:px-6 lg:px-20 shadow-lg flex flex-col md:flex-row justify-start md:items-start md:gap-10">
        <div className="flex-shrink-0 mb-4 md:mb-0 lg:w-1/3">
          <h2 className="text-4xl text-center md:text-left 3xl:text-6xl 4xl:text-7xl font-bold mb-2">
        ...
        <div className="flex-grow lg:w-2/3">
          <p className="text-base md:text-base lg:text-xl 2xl:text-2xl 3xl:text-3xl 4xl:text-4xl">
          ...
          <p className="text-base md:text-base lg:text-xl 2xl:text-2xl 3xl:text-3xl 4xl:text-4xl mt-5">
