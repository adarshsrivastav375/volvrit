    ...
    <div className="bg-[#0C2C4F]">
      <div className="relative text-white px-4 md:px-6 lg:px-20 max-w-9xl mx-auto overflow-hidden">
        <div className="flex justify-between items-center gap-20">
          <div className="lg:w-1/2">
            <h2 className="text-3xl 2xl:text-4xl 3xl:text-5xl 4xl:text-6xl font-bold mb-8">
        ...
        <Image
          ...
          unoptimized
          priority
          className="w-64 absolute -left-20 top-0"
        />
      </div>
      <div className="relative overflow-hidden">
        ...
        <Image
          ...
          unoptimized
          priority
          className="w-96 absolute -right-10 -top-10"
        />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 z-40 relative gap-10 p-20 pt-0">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-[#0B335E] p-6 border-l-2 border-l-slate-400 py-20 shadow-md"
            >
