      ...
      <div className="relative z-10 flex flex-col justify-center items-center max-w-9xl mx-auto px-4 md:px-6 lg:px-20 pt-10 md:pt-20 lg:pt-[25vh]">
        <div className="text-center">
          <div className="flex justify-center mx-auto items-center gap-5">
            ...
            />
            <h4 className="text-2xl md:text-4xl 2xl:text-5xl 3xl:text-6xl 4xl:text-7xl font-semibold">
              Unlock the Full Potential of Shopify with <br /> Expert
          ...
          <div className="w-full relative flex flex-col items-center justify-center">
            ...
            <Image
              ...
              height={100}
              alt="Mobile Banner"
              src="https://volvrit.s3.ap-south-1.amazonaws.com/MacBookair.png"
            ...
            <div className="w-20 h-20 rounded-3xl shadow-2xl bg-transparent border-y border-y-slate-100 absolute -top-1/4 rotate-12 right-0"></div>
          </div>
        </div>
      </div>
    </div>
