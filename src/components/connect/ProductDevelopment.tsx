    ...
    <div className="container mx-auto p-4 lg:pt-20">
      ...
      <div className="relative flex justify-center items-center">
        <Image
          ...
          className="w-full"
        />
        <div className="absolute bg-gray-100 inset-0 grid grid-cols-3 grid-rows-2 gap-4 py-20 px-10 items-center rounded-sm mt-10 sm:hidden lg:h-fit mx-auto w-9/12">
          {steps.map((step, index) => (
            <div key={index} className="bg-transparent lg:h-44 p-7">
              <h2 className="text-5xl text-gray-400 font-bold">
                {"0" + "" + index}
              </h2>
