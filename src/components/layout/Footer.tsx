      ...
      <div className="w-full mx-auto px-4 md:px-6 lg:px-20">
        <div className="md:grid md:grid-cols-4 justify-between items-start md:gap-10 lg:gap-20">
          <div className="text-left mb-6 lg:mb-0">
            <Logo size={50} />
            <p className="text-black md:text-[11px] lg:text-sm 2xl:text-xl my-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 col-span-3 justify-center lg:justify-between w-full">
            {services.map((service) => (
              ...
              >
                <h3 className="font-bold 2xl:text-2xl mb-5">{service.title}</h3>
                <ul className="text-black space-y-2">
                  {service.links.map((link) => (
                    <li
                      key={link.href}
                      className="text-xs md:text-[10px] 2xl:text-lg lg:text-xs"
                    >
                      <Link
            ...
            <div className="w-full mb-6 lg:mb-0">
              <h3 className="font-bold 2xl:text-2xl mb-5">Contact Address</h3>
              <ul className="text-black space-y-2">
                <li className="text-sm leading-4 md:text-[10px] lg:text-xs 2xl:text-lg">
                  <span className="font-bold text-base md:text-xs 2xl:text-xl pb-1">
                    India
                  </span>{" "}
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-0 justify-between items-start md:items-center mt-2 md:mt-10 text-xs 2xl:text-lg text-left md:text-center lg:text-left text-black">
          <p>
