  ...
  return (
    <footer className="bg-gray-50 pt-5 md:pt-10 pb-4 md:pb-7">
      <div className="container mx-auto px-4 md:px-6 lg:px-20">
        <div className="md:grid md:grid-cols-4 justify-between items-start md:gap-10 lg:gap-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 col-span-3 justify-center lg:justify-between w-full">
            ...
            <div className="w-full mb-6 lg:mb-0">
              ...
              <ul className="text-black space-y-2">
                <li className="text-sm leading-4 md:text-[10px] lg:text-xs">
                  <span className="font-bold text-base md:text-xs pb-1">
                    Dubai
                  </span>{" "}
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-0 justify-between items-start md:items-center mt-2 md:mt-10 text-xs text-left md:text-center lg:text-left text-black">
          <p>
